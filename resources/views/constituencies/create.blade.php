    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-lg border-0 mb-5 bg-white rounded">
                <div class="card-header border-0 bg-info text-white font-weight-bold"><i class="fas fa-plus"></i> {{ __('Create New Constituency ') }}</div>
                ...
                <div class="card-body text-muted">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="constituency_name" type="text" class="form-control{{ $errors->has('constituency_name') ? ' is-invalid' : '' }}" value="{{old('constituency_name')}}" name="constituency_name" required data-validation-required-message= "Please enter   Location name." required autofocus>
