...
<body class="sidebar-mini sidebar-open">
	<div class="wrapper">
		<nav class="main-header navbar navbar-expand-md bg-white navbar-light border-bottom">
		...
		<div class="content-wrapper">
			...
			<a id="navbarDropdown" class="" href="# " role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="margin-left:80%">
			        <span class="caret fa fa-user">USER:</span>  {{ Auth::user()->name ?? '' }} 
			    </a>
			@yield('content')
			</section>
			<!-- /.content -->
		...
		<footer class="main-footer">
			...
			<b>DirectoryPro</b> ver 1.0
			</div>
			<strong> &copy;</strong> 2019 Directcore Technologies. All Rights Reserved.
		</footer>
