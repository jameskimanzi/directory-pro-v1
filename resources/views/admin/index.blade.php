...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav navbar-light sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.home') }}">
        <img src="/images/logo.jpg" alt="logo" style="width:120px;height:100px;margin-left:0px; margin-bottom: 2rem;padding-top: 2rem">
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link text-gray-900" href="{{ route('admin.home') }}">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('groups.index') }}"><i class="fas fa-users"></i> Groups</a>
            @endcan
          </div>
        </div>
      </li>
  ...
  <script src="{{asset ('js/demo/chart-pie-demo.js')}}"></script>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route('counties.index') }'">Provincial</a>
